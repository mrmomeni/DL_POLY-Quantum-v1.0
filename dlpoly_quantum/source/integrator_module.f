...
c     eliminate "flying ice cube" in long simulations (Berendsen)
     ...
     x  nchain,nrespa,ngrp,ntpmls,
     x  keyens,nscons,ntcons,ntpatm,ntfree,nspmf,ntpmf,mode,nofic,
     x  ntshl,keyshl,tstep,engke,engrot,tolnce,vircon,vircom,virtot,
     x  temp,press,volm,sigma,sigma_nhc,sigma_volm,alpha_volm,
     x  taut,taup,g_qt4f,g_qt4f_1,chit,chip,consv,
...
c***********************************************************************
      ...
      real(8) sigma_nhc,sigma_volm,alpha_volm
...
c     eliminate "flying ice cube" in long simulations (Berendsen)
     ...
     x  taut,g_qt4f,g_qt4f_1,temp,engke,engthe,chi,uuu,gaumom)
...
c     nvt ensemble
     ...
     x  g_qt4f,g_qt4f_1,engke,engthe)
...
c     nvt ensemble - gentle thermostat
        ...
        call pimd_nvt_gth1
     x  (lmsite,isw,idnode,mxnode,natms,imcon,ntpmls,tstep,taut,temp,
     x  g_qt4f,g_qt4f_1,engke,engthe,chi,uuu)
...
c     nvt ensemble - nose-hoover chains
     ...
     x    g_qt4f,g_qt4f_1,temp,engke,engthe)
