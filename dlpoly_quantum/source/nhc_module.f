...
c**********************************************************************
c     
c     dl_poly_quantum routine to allocate arrays for Nose-Hoover Chain
c     
...
c**********************************************************************
c     
c     dl_poly_quantum routine to deallocate arrays for Nose-Hoover Chain
c     
c     copyright - daresbury laboratory
c     M.R.Momeni & F.A. Shakib
c     
...
c**********************************************************************
c     
c     dl_poly_classic routine to initialise NVT-NHC thermostat
c     
c     copyright - daresbury laboratory
c    
c     
