...
c        heta_nhc=2.d0*sigma*eta_nhc(1)
c          do j=2,nchain
c             heta_nhc=heta_nhc+eta_nhc(j)
c          enddo
c        heta_nhc=2.d0*sigma_nhc*heta_nhc

c        hpeta=0.5d0*(peta(1)**2/qmass_t)
c          do j=2,nchain
c             hpeta=hpeta+0.5d0*(peta(j)**2/qmass_part)
c          enddo   

c        consv=heta_nhc+hpeta
