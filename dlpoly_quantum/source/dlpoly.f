...
c     declare required modules
      ...
      real(8) sigma_nhc,sigma_volm,alpha_volm,g_qt4f,g_qt4f_1
...
c     input the control parameters defining the simulation
     ...
     x  nsolva,isolva,nofic,nbeads,nchain,nrespa,g_qt4f,g_qt4f_1,alpha,
...
c     construct initial configuration of system
     ...
     x  g_qt4f,g_qt4f_1,delr,rcut,temp,volm,uuu)
...
c     integrate equations of motion stage 1 of velocity verlet
     ...
     x      tstep,taut,g_qt4f,g_qt4f_1,temp,engke,engthe,chi,uuu,gaumom)
     ...
     x        nstep,nchain,nrespa,ngrp,ntpmls,
     x        keyens,nscons,ntcons,ntpatm,ntfree,nspmf,ntpmf,mode,nofic,
     x        ntshl,keyshl,tstep,engke,engrot,tolnce,vircon,vircom,
     x        virtot,temp,press,volm,sigma,sigma_nhc,sigma_volm,
     x        alpha_volm,taut,taup,g_qt4f,g_qt4f_1,chit,chip,consv,
