...
c     allocation is based on arrays that are scanned in setup_module
      ...
      allocate (qt4index(mxatms),stat=fail(4))
...
c     initialise qt4index array for water model qtip4p/f
      ...
      subroutine define_voids(safe,idnode,itmols,nvoids)
...
c***********************************************************************
      ...
      integer idnode,itmols,nvoids,ntmp,ivoid,keytmp
...
c     read void parameters
      ...
      subroutine water_index(ntpmls,iqt4)
...
c     qtip4p/f water model indices
      ...
      subroutine qtip4pf(idnode,imcon,ntpmls,g_qt4f,g_qt4f_1)
...
c***********************************************************************
      ...
      integer i,mqt4,idnode,imcon
      integer oxi,h1i,h2i
      integer, intent(in) :: ntpmls
      real(8) xho(2),yho(2),zho(2)
      real(8), intent(in) :: g_qt4f,g_qt4f_1
      ...
      subroutine qt4_force_redist(ntpmls,g_qt4f,g_qt4f_1)
